...
class RssfeedSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        print(f"[red]     name: {name},    title: {title},    Discription: {description}")    
    ...
    def parse_rss_links(self,response):
        ...
        try:
            ...
            if response.xpath('//channel'):
                ...
                get_link=response.xpath("//section[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[2]/ul[1]/li/a/@href  |\
                   //article[@id='2050306']//section/p[2]//a/@href").extract()
                # print(get_link)
                if get_link:
